...
public class TendererSearchBean implements Serializable {
    ...
    /**
     * Tests if the period of time between now and the last request for review
     * sent by the contractor is superior than the interval
     *
     * @param contractorID the id of the contractor
     * @param tendererID the id of the tenderer
     * @return true if the contractor can send a request for review to the
     * tenderer
     */
